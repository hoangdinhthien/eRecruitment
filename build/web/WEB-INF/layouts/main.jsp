<%-- Document : main Created on : Sep 23, 2022, 9:34:15 AM Author : Thien's --%>
    <%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@page contentType="text/html" pageEncoding="UTF-8" %>
            ...
            <body>
                ...
                =======
                >>>>>>> 7e4dd84cc3af06499ed3fe117efcd4af3a35d56d
                <!-- Humberger End -->
                                                    ...
                                                    <ul class="login-ava">
                                                        <li style="list-style-type:none">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li style="list-style-type:none">
                                                                    <a class="link" href="<c:url value="
                                                                        /interview?op=set_schedule" />">Set Interview
                                                                    Schedule</a>
                                                                </li>
                                                                <li style="list-style-type:none">
                                                                    <a class="link" href="<c:url value="
                                                    ...
                                                    <ul class="login-ava">
                                                        <li style="list-style-type:none">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li style="list-style-type:none">
                                                                    <a class="link" href="<c:url value="
                                                                        /interview?op=interview_schedule&email=${info.email}" />">Interview
                                                                    Schedule</a>
                                                    ...
                                                    <ul class="login-ava">
                                                        <li style="list-style-type:none">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li style="list-style-type:none">
                                                                    <a class="link" href="<c:url value="
                                                                        /interview?op=interview_process&email=${info.email}" />">Interview
                                                                    process</a>
                                                        ...
                                                        <div class="popuptext" id="myPopup">
                                                            <div style="width: 100%;">
                                                                ...
                                                                <div class="google-btn" style=" margin: auto">
                                                                    <a
                                                                        href="https://accounts.google.com/o/oauth2/auth?scope=email  profile&redirect_uri=http://localhost:8084/recruitment-system/login?op=login&response_type=code&client_id=779040387699-c58vkqmlf6cmvtv3som469pl5k78lgar.apps.googleusercontent.com&approval_prompt=force">
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="header__logo">
                                    <a href="<c:url value='/home?op=index'/>"><img
                                            src="img/banner/logo-recruitment2.png" alt=""></a>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <nav class="header__menu">
                                    <ul>
                                        <li class="${empty list?'active':'link'}"><a
                                                href="<c:url value='/home?op=index'/>">Home</a></li>
                                        <li class="${not empty list?'active':'link'}"><a href="<c:url value="
                                                /job?op=list" />">Jobs</a></li>

                                        <c:if test="${not empty info && role == 'Interviewer' || role == 'HR Staff'}">
                                            <li><a href="<c:url value=" /exam?op=QuestionBank" />"> Exam </a>
                                                <ul class="header__menu__dropdown">
                                                    <li><a href="<c:url value=" /exam?op=QuestionBank" />">Question
                                                        Bank</a></li>
                                                    <li><a href="<c:url value="
                                                            /exam?op=confirmExam&canId=C001" />">Test Exam</a></li>
                                                    <!--<li><a href="#">Shoping Cart</a></li>-->
                                                </ul>
                                            </li>
                                        </c:if>
                                        ...
                                        <li><a href="<c:url value=" /apply?op=listAll" />"> Application </a>
                                            <ul class="header__menu__dropdown">
                                                <li><a class="link" href="<c:url value=" /apply?op=listAll" />">List All
                                                    Applications</a></li>
                                                <li><a class="link" href="<c:url value=" /apply?op=list0" />">Newest
                                                    Applications</a></li>
                                                <li><a class="link" href="<c:url value="
                                                        /apply?op=listPending" />">Pending Applications</a></li>
                                                <li><a class="link" href="<c:url value=" /apply?op=list4" />">Recruit
                                                    Candidates</a></li>
                                            </ul>
                                            ...
                                            <div id="notification-container">
                                                ...
                                                <div id="notification-body">
                                                    <c:forEach items="${listNotification}" var="notification">
                                                        ...
                                                        <c:if
                                                            test="${notification.linkTitle != null && notification.link != null}">
                                                            <a href="<c:url value="
                                                                /user?op=toLink&nId=${notification.nId}" />">${notification.linkTitle}</a>
                                                        </c:if><br />
                                                        <c:if test="${notification.isRead}">
                                                            Readed | <a href="<c:url value="
                                                                /user?op=delete&nId=${notification.nId}" />">Delete</a>
                                                        </c:if>
                                                        <c:if test="${!notification.isRead}">
                                                            New | <a href="<c:url value="
                                                                /user?op=read&nId=${notification.nId}" />">Mark as
                                                            read</a>
                                                        </c:if>
                                                ...
                                                <div id="notification-footer"><a href="<c:url value="
                                                        /user?op=listNotification" />">See All</a></div>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <li class="dropdown dropdown-1">
                                    ...
                                    <ul class="dropdown_menu dropdown_menu-1">
                                        <c:forEach var="major" items="${listMajor}" varStatus="loop">
                                            <a href="<c:url value="
                                                /job?major_id=${major.major_id}&level_id=0&salary=0&op=filter_job" />"
